...
# ~~~
#
# The resources will be fetched from the target installation directory <prefix>/Resources TODO
# modify the resources installation directory access to allow customisable install
...
# Install resources for the target  theTarget: - Link( copy under window ) the resource dir
# RESOURCES_DIR into the buildtree at the given BUILD_LOCATION - Install the required files into the
# TARGET_INSTALL_DIR/Resources[/PREFIX] directory If called only with a directory, all the files
# from this directory and subdirs will be installed This function also define the custom properties
# RADIUM_RESOURCE_DIRECTORY and RADIUM_RESOURCE_FILES for the given target with the corresponding
# value. To be called with
# ~~~
